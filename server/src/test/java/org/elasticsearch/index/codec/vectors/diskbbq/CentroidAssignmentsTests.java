...
public class CentroidAssignmentsTests extends ESTestCase {
    ...
    public void testBasicCentroidInformation() {
        ...
        CentroidInformation<float[]> ci = CentroidInformation.ofFloat(dims, centroids, assignments, new SoarAssignments(overspill));
    ...
    public void testGlobalCentroid() {
        ...
        CentroidInformation<float[]> ci = CentroidInformation.ofFloat(dims, centroids, assignments, OverspillAssignments.NONE);
    ...
    public void testWithCentroidSlices() {
        ...
        CentroidInformation<float[]> ci = CentroidInformation.ofFloat(dims, centroids, assignments, new SoarAssignments(overspill), slices);
